...
public class ClothingItem {
    private final String id;    // Уникальный идентификатор товара, final - поэтому что id не меняется после создания
    private  String name;   // Название товара
    private String size;    // Размер (например, "S" "М", "L", "XL")
